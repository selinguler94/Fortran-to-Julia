...
md"""# Probability of States in Isolated Systems"""
...
# ╔═╡ 3245d2c2-2eff-4e47-9503-747191dd4e6a
gr()

# ╔═╡ a870b6b4-d66b-4755-9b7d-18bc67aa86e9
for i in Et
	plot!(0:Totalenergy, i)
	sleep(0.2)
end
...
begin
	n = 0
	while (n * (n + 1) / 2) <= Totalenergy
	    n += 1
	end
	energy_levels = collect(Int, 1:1:n)
end

# ╔═╡ 99e0bd9d-f935-4c1a-b460-beee315caa88
histogram(0:Totalenergy, Oscillator/Numberofoscillators, bins=10, 
...
manifest_format = "2.0"
project_hash = "f25c86ac4d87d3630d421324773222b47dc49f2c"
